...
const Navbar = () => {
  return (
    <nav className="bg-white border-b-2 border-neutral-300 flex justify-between items-center py-5 px-20">
      <div className="text-neutral-400 font-medium">
        <span className="text-text-lg pr-5">Your Profile</span>
        <span className="pr-5">{">"}</span>
        <span className="text-pink-600">Dashboard</span>
      </div>
      <div className="text-neutral-700 font-medium flex ">
        <span className="pr-5">Dave Copperfield</span>
